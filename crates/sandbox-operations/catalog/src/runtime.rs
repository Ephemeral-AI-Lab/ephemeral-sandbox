...
pub use workspace_session::{
    ...
    ROLLBACK_WORKSPACE_SESSION_SPEC, SQUASH_MPLA_BRANCH_SPEC, WORKSPACE_SESSION_FAMILY,
};
...
const OPERATIONS: &[&RoutedOperation] = &[
    ...
    &workspace_session::CREATE_MPLA_WORKSPACE_SESSION,
    &workspace_session::ATTACH_MPLA_PREPARED_FIXTURE,
    &workspace_session::ACTIVATE_WORKSPACE_SESSION,
    &workspace_session::FORK_WORKSPACE_SESSION,
    &workspace_session::ROLLBACK_WORKSPACE_SESSION,
    &workspace_session::PUBLISH_MPLA_WORKSPACE_SESSION,
    &workspace_session::SQUASH_MPLA_BRANCH,
    &workspace_session::PUBLISH_WORKSPACE_SESSION,
    &workspace_session::DESTROY_WORKSPACE_SESSION,
    &workspace_session::MPLA_STORAGE_ADMIN,
];
