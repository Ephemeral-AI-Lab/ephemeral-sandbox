...
_SANDBOX_EVENT_MAP = {
    ...
    sandbox_events.SHELL_LAUNCHED: EventType.SANDBOX_SHELL_LAUNCHED,
    sandbox_events.SHELL_CANCELLED: EventType.SANDBOX_SHELL_CANCELLED,
    sandbox_events.SHELL_REAPED: EventType.SANDBOX_SHELL_REAPED,
}
