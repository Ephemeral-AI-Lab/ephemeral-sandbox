...
POSTED_SUBAGENT_RESULT_GUIDANCE = (
    ...
    '`read_task_note(scope="own", paths=None, '
    'task_note="Read posted scout notes")` when you need all current-task '
    "scout notes, or `read_task_note(paths=[...])` for known scout scopes."
)
